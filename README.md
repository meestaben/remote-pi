...
- Docker bridge networks are permitted outbound via `firewall_docker_subnets` (default `172.16.0.0/12` covering 172.16-172.31). Add any additional container subnets there and rerun `ansible-playbook ... --tags firewall` if your stacks use other bridges.
